import { Mesh, Group, BufferGeometry, LineBasicMaterial, Line, Vector3, Color, Geometry, VertexColors, ParticleBasicMaterial, AdditiveBlending, TextureLoader } from 'three';
...
export default class Square extends Group {
  constructor() {
    ...
    for (var i = 1; i < 10; i = i + 2) {
      ...
      points.push( new Vector3( i*7, 0, -i*6 ) );
      points.push( new Vector3(  0, i*7, -i*6 ) );
      points.push( new Vector3( - i*7, 0, -i*6 ) );
      points.push( new Vector3( 0, -i*7, -i*6 ) );
  ...
  update(dataArray, rotate, timeStamp) {
    ...
    for (var i = 0; i < numShapes; i++) {
      ...
      meshes[i].material.color = new Color("rgb(" + color + ", 238, 255)")
